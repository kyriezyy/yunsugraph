...
class D3Graph {
  constructor(svgId) {
    ...
    this.simulation = d3.forceSimulation()
      .alpha(0.5)
      .velocityDecay(0.7)
      .force('collision', d3.forceCollide().radius(30).strength(0.9)) // 决定线的长度已经节点之间的间距
      .force('link', d3.forceLink().distance(200).strength(0.5)) // 决定线的长度已经节点之间的间距
      .force('charge', d3.forceManyBody().strength(-200).distanceMin(200)) // 节点是否所在一起 相互吸引 相互排斥相关
